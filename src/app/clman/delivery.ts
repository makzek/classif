...
import { pipRX, AllRows, criteries } from './../services/pipRX.service';


@Component({
	selector: 'clman-delivery',
	template: `
	   <div>
	...
	<delivery-detail [it]=currentItem></delivery-detail>
...
export class DeliveryComponent implements OnInit {
	...
	ngOnInit() {
		this.pip.read<DELIVERY_CL>({
			...
			//DELIVERY_CL: [1, 3775, 3776, 3777, 3778, 3779, 1021138, 1021139, 1032930, 1032965, 1032932, 1033581, 1033582, 1037443, 1037634,
	...
	onAdd() {
		...
		var tmp = this.pip.prepareAdded<DELIVERY_CL>({ ISN_LCLASSIF: this.pip.SequenceMap.GetTempISN(), CLASSIF_NAME: "Добавляем?" }, "DELIVERY_CL")
