...
export const NODES = [
    { id: '1', code: '1', title: 'Общая тематика', isNode: true, isDeleted: false, description: 'description', hasSubnodes: true },
    ...
    { id: '6', code: '2', title: 'Обращения граждан', isNode: true, isDeleted: false, description: 'description', hasSubnodes: false },
    { id: '7', code: '3', title: 'Финансы', isNode: false, isDeleted: false, description: 'description', hasSubnodes: false },
];
